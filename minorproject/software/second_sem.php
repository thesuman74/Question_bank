	...
	<?php 
			include('../../admin/connection.inc.php');
			              $subject = "SELECT * FROM subject WHERE state_id = '10'";
			              $link = "SELECT link FROM questions WHERE semester ='II'";
...
<head>
	...
	<title>Second_sem_subjects</title>
					...
					<div class="section-header align-center">
						<div class="title">
							<div class="row float-left">
								<span class="text-danger "><a class="text-secondary " href="../courses.php">courses</a>>><a class="text-secondary " href="semesters.php">Software</a>>><a class="text-secondary " href="">Second semester</a></span>
