	...
	<?php 
			include('../../admin/connection.inc.php');
			              $subject = "SELECT * FROM subject WHERE state_id = '12'";
					...
					<div class="section-header align-center">
						<div class="title">
							<div class="row float-left">
								<span class="text-danger "><a class="text-secondary " href="../courses.php">courses</a>>><a class="text-secondary " href="semesters.php">Software</a>>><a class="text-secondary " href="subjects.php">Fourth semester</a></span>
